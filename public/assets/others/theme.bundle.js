(() => {
    ...
    r.l = (e, t, s, o) => {
        if (n[e])
            ...
            var h = (t, i) => {
                    ...
                    clearTimeout(p);
                    var s = n[e];
                    if (delete n[e], a.parentNode && a.parentNode.removeChild(a), s && s.forEach((e => e(i))), t)
                        return t(i)
                },
    ...
    (() => {
        ...
        function ee(e) {
            ...
            if (f) {
                var S = R(r),
                    D = "clientHeight",
                    O = "clientWidth";
                if (S === x(r) && "static" !== H(S = Y(r)).position && "absolute" === h && (D = "scrollHeight", O = "scrollWidth"), l === t || (l === s || l === i) && d === c)
                    C = n,
        ...
        const Ee = {
            ...
            fn: function(e) {
                var n = e.state,
                    ...
                    u = d.x,
                    h = d.y;
                null != n.modifiersData.popperOffsets && (n.modifiersData.popperOffsets.x += u, n.modifiersData.popperOffsets.y += h),
                n.modifiersData[r] = c
            }
        };
        const ke = {
        ...
        class wt extends yt {
            ...
            {
                super(),
                (e = qe(e)) && (this._element = e, this._config = this._getConfig(t), mt.set(this._element, this.constructor.DATA_KEY, this))
            }
            dispose()
            {
        ...
        class Bt extends yt {
            constructor(e, t)
            {
                super(),
                this._element = e,
                e && Bt.isSupported() && (this._config = this._getConfig(t), this._deltaX = 0, this._supportPointerEvents = Boolean(window.PointerEvent), this._initEvents())
            }
            static get Default()
            {
                return jt
        ...
        class ln extends wt {
            ...
            _addEventListeners()
            {
                ...
                "hover" === this._config.pause && (pt.on(this._element, Vt, (() => this.pause())), pt.on(this._element, Ut, (() => this._maybeEnableCycle()))),
        ...
        class Rs extends wt {
            constructor(e)
            {
                ...
                this._parent && (this._setInitialAttributes(this._parent, this._getChildren()), pt.on(this._element, $s, (e => this._keydown(e))))
            }
            static get NAME()
            {
                return "tab"
