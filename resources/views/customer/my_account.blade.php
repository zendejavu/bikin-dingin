                    ...
                    <div class="card border-0 scroll-mt-3" id="dataDiri">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-lg">
                                    <input type="text" class="form-control" id="emailAddress" value="{{ Auth::user()->email }}">
                                ...
                                <div class="col-lg">
                                    <div class="mb-4">
                                        <select class="form-select" id="province" required autocomplete="off" data-select='{
                                            ...
                                            <option value="" label="Pilih Provinsi Anda"></option>
                                    ...
                                    <div class="mb-4">
                                        <input type="text" class="form-control" id="city" value="{{ Auth::user()->city }}" placeholder="Kota/Kabupaten">
                                        <div class="invalid-feedback">Please add a city</div>
                                    </div>
    
                                    <div class="mb-4">
                                        <input type="text" class="form-control" id="subdistrict" value="{{ Auth::user()->subdistrict }}" placeholder="Kecamatan">
                                        <div class="invalid-feedback">Please add a state or county</div>
                                    </div>
    
                                    <div class="mb-4">
                                        <input type="text" class="form-control" id="village" value="{{ Auth::user()->village }}" placeholder="Desa/Kelurahan">
                                        <div class="invalid-feedback">Please add a state or county</div>
                                    </div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-lg">
                                    <input type="text" class="form-control" id="addressLine1" value="{{ Auth::user()->address }}">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-lg">
                                    <input type="text" class="form-control" id="zipCode" value="{{ Auth::user()->zip }}">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-lg">
                                    <textarea class="form-control" id="overview" rows="4">{{ Auth::user()->bio }}</textarea>
